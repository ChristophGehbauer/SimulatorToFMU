within SimulatorToFMU.Python310;
...
<a href=\"modelica://SimulatorToFMU.Python310.Functions.simulator\">
SimulatorToFMU.Python310.Functions.simulator</a>
...
<p>
The examples
<a href=\"modelica://SimulatorToFMU.Python310.Functions.Examples.Simulator\">
SimulatorToFMU.Python310.Functions.Examples.Simulator</a>
and
<a href=\"modelica://SimulatorToFMU.Python310.Functions.Examples.SimulatorWithPassMemoryObject\">
SimulatorToFMU.Python310.Functions.Examples.SimulatorWithPassMemoryObject</a>
contains various calls to different Python functions without and with memory.
</p>
<p>
The example
<a href=\"modelica://SimulatorToFMU.Python310.Examples.KalmanFilter\">
SimulatorToFMU.Python310.Examples.KalmanFilter</a>
...
<p>
The example
<a href=\"modelica://SimulatorToFMU.Python310.Examples.SimpleRoom\">
SimulatorToFMU.Python310.Examples.SimpleRoom</a>
...
Traceback (most recent call last):
  File \"/usr/lib/python3.4/site.py\", line 563, in &lt;module&gt;
    main()
  File \"/usr/lib/python3.4/site.py\", line 545, in main
    known_paths = addusersitepackages(known_paths)
  File \"/usr/lib/python3.4/site.py\", line 272, in addusersitepackages
    user_site = getusersitepackages()
  File \"/usr/lib/python3.4/site.py\", line 3.4, in getusersitepackages
    user_base = getuserbase() # this will also set USER_BASE
  File \"/usr/lib/python3.4/site.py\", line 3.4, in getuserbase
    USER_BASE = get_config_var('userbase')
  File \"/usr/lib/python3.4/sysconfig.py\", line 578, in get_config_var
    return get_config_vars().get(name)
  File \"/usr/lib/python3.4/sysconfig.py\", line 524, in get_config_vars
    _init_posix(_CONFIG_VARS)
  File \"/usr/lib/python3.4/sysconfig.py\", line 408, in _init_posix
...
<p>
See also <a href=\"https://bugs.launchpad.net/ubuntu/+source/python3.4/+bug/1115466\">
https://bugs.launchpad.net/ubuntu/+source/python3.4/+bug/1115466</a>.
</p>
</html>"));
end UsersGuide;
