...
model SimulatorWithPassMemoryObject
  ...
  SimulatorToFMU.Python310.Functions.BaseClasses.PythonObject obj=
...
algorithm
  ...
  annotation (
    ...
    __Dymola_Commands(file="modelica://SimulatorToFMU.Resources/Scripts/Dymola/Python310/Functions/Examples/SimulatorWithpassMemoryObject.mos"
        "Simulate and plot"),
