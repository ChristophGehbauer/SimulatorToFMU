within SimulatorToFMU.Python310.Functions.Examples;
model Simulator "Test model for simulator functions"
  ...
  SimulatorToFMU.Python310.Functions.BaseClasses.PythonObject[5] obj={
      SimulatorToFMU.Python310.Functions.BaseClasses.PythonObject(patResScri=
      patResScri) for i in 1:5};
  Real yR1[1] "Real function value";
  Real yR2[2] "Real function value";

algorithm
  yR1 := SimulatorToFMU.Python310.Functions.simulator(
  ...
  yR2 := SimulatorToFMU.Python310.Functions.simulator(
    moduleName="testSimulator",
    functionName="r1_r2",
    obj=obj[4],
    passMemoryObject=passMemoryObject,
  ...
  annotation (
    ...
    __Dymola_Commands(file="modelica://SimulatorToFMU.Resources/Scripts/Dymola/Python310/Functions/Examples/Simulator.mos"
        "Simulate and plot"),
